...
const IoMdNotificationsOutlineIcon = ({ size }) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 512 512" 
...
export default function InventairesScreen() {
  ...
  // Notification system (comme stocks.jsx)
  ...
  const exportChartAsPdf = () => {
    if (!chartRef.current) {
      showNotification('Graphique non disponible.', 'warning');
      return;
    }
        ...
        <div className="stats-cards-container">
          ...
          <div style={{ marginLeft: 'auto' }}>
            <button className="pdf-button" onClick={exportChartAsPdf}>
              <IoDocumentTextOutline /> Exporter le Graphe
            </button>
          </div>
        </div>
  ...
  return (
    <div className="container-fluid">
      {/* CSS Styles basé sur livraison.jsx et stocks.jsx */}
      <style>{`
        ...
        /* === NOTIFICATION STYLES (comme stocks.jsx) === */
        ...
        /* Notification Icon (comme stocks.jsx) */
        .notification-button {
          background: none; 
          border: none; 
          cursor: pointer; 
      ...
      <div className="main-content">
        ...
        <div className="header">
          ...
          <h1 className="header-title">Gestion d'Inventaire</h1>
      ...
      {showNotificationPanel && (
        <div className="alert-panel">
          <div className="alert-header">
            <div className="alert-title">Alertes Inventaire</div>
            <button 
