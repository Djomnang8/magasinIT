...
inventaireRouter.post('/', async (req, res) => {
  try {
    ...
    res.status(201).json({ id_inventaire: result.insertId, nom_produit, total_entree, total_attribution, total_sortie, comparaison, variation_mensuelle, variation_annuelle });
  } catch (error) {
